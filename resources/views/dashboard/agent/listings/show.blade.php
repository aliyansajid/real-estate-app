...
@section('breadcrumb_title', 'Property Details')
                                            ...
                                            <div class="col-md-12">
                                                <ul class="list-unstyled">
                                                    ...
                                                    @if($listing->purpose == 'sale')
                                                        <li class="mb-1"><strong>Price:</strong> <span id="price">{{ number_format($listing->price) }}</span></li>
                                                    @elseif($listing->purpose == 'rent')
                                                        <li class="mb-1"><strong>Rent:</strong> <span id="rent">{{ number_format($listing->price_per_month) }}</span></li>
                                                    @else
...
<script>
    function formatPrice(number) {
        if (number >= 10000000) {
            return 'PKR ' + (number / 10000000).toFixed(2) + ' Crore';
        }
        else if (number >= 100000) {
            return 'PKR ' + (number / 100000).toFixed(2) + ' Lakh';
        }
        else {
    ...
    window.onload = function() {
        ...
        let rent = {{ $listing->price_per_month ?? 0 }};
        ...
        if (rent > 0) {
            document.getElementById('rent').innerHTML = formatPrice(rent);
        }
    }
</script>
@endsection
