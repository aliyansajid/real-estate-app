        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <p class="text-capitalize text-white">We will assist you in the best and most comfortable property services for you.</p>
                </div>
                <div class="col-lg-3">
                    <a href="{{ route('contact') }}" class="btn btn-light text-uppercase">Request a Quote <i class="fa fa-angle-right ml-3 arrow-btn"></i></a>
                </div>
            </div>
        </div>
    </section>
